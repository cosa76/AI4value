...
warnings.filterwarnings("ignore", category=UserWarning)  # Ignore toutes les UserWarnings temporairement
...
def evaluate_relations(df, target_col, var_types):
    ...
    # Si la variable cible est catégorielle, on force à discretiser
    ...
    for feat in features:
        if feat not in df.columns:
            continue
        # Si la feature est numérique, on remplace par médiane
